...
<div class="well" style="height:400px; width:680px;  color:#666666" >
<ul class="nav navbar-nav navbar-left">
				<br> <p><img  src="assets/img/doctor_model.jpg"  class="img-responsive" width="300"/></p>
					
			  </ul>
			   
			 
			  <br><br><br><br><br><h1><i>Prise en Charge<br> 
			  par un medecin <br>
			  de famille<br></i></h1>
...
<div class="well"  style=" height:200px; width:300px; color:#666666">

			   
			<ul class="nav navbar-nav navbar-left">  
			  <center><h4><i>Prise en Charge<br> 
			  <br></i></h4></center>
		  <ul>
			  
			  
			  Selon la disponibilité des médecins,<br>
        nous offrons de la prise en charge<br>
		 par un médecin de famille<br>
